...
Color _kActiveTickColor = CupertinoDynamicColor.withBrightness(
...
class GFCupertinoActivityIndicator extends StatefulWidget {
  /// Creates an iOS-style activity indicator that spins clockwise.
  const GFCupertinoActivityIndicator({
    Key key,
    this.animating = true,
  ...
  @override
  _GFCupertinoActivityIndicatorState createState() =>
      _GFCupertinoActivityIndicatorState();
}

class _GFCupertinoActivityIndicatorState
    extends State<GFCupertinoActivityIndicator>
  ...
  @override
  void didUpdateWidget(GFCupertinoActivityIndicator oldWidget) {
